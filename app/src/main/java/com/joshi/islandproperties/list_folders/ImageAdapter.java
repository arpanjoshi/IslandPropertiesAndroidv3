package com.joshi.islandproperties.list_folders;
...
import com.joshi.islandproperties.DetailActivity;
import com.joshi.islandproperties.R;
import com.joshi.islandproperties.dropbox_classes.FileThumbnailRequestHandler;
...
public class ImageAdapter extends RecyclerView.Adapter<ImageAdapter.MetadataViewHolder> {
    private List<Metadata> mFiles;
    private final Picasso mPicasso;
    private final ImageAdapter.Callback mCallback;
    ...
    public ImageAdapter(Picasso picasso, ImageAdapter.Callback callback) {
        mPicasso = picasso;
        mCallback = callback;
    }

    @Override
    public ImageAdapter.MetadataViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        Context context = viewGroup.getContext();
        View view = LayoutInflater.from(context)
                .inflate(R.layout.grid_item, viewGroup, false);
        return new ImageAdapter.MetadataViewHolder(view);
    }

    @Override
    public void onBindViewHolder(ImageAdapter.MetadataViewHolder metadataViewHolder, int i) {
            ...
            if (item instanceof FileMetadata) {
                ...
                if (type != null && type.startsWith("image/")) {
                    ...
                    mPicasso.load(FileThumbnailRequestHandler.buildPicassoUri((FileMetadata)item))
                            .placeholder(R.drawable.ic_photo_grey_600_36dp)
                            .error(R.drawable.ic_photo_grey_600_36dp)
                            .into(DetailActivity.largeImage);
